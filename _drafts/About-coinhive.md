...
Coinhiveを使った採掘用のスクリプトを用意してみました。実際にいくら位の収益が上がるのかをお試し頂けます。現状、全くカネにならないことがお分かりいただけるでしょう。

Startボタンを押すと採掘が始まり、具体的な収益が表示されます。収益は私の手元に入ることになりますが、はたしてジュース1本分集まるかどうか…。
...
上記のソースコードは[ここ](https://gist.github.com/tkihira/291f13d93918cee594eeff54e71ffdbe)に用意しました。
